...
const TableProduct = () => {
  ...
  const [data, setData] = useState([]); //mendefinisikan data sbg state dgn nilai array kosong
  const [count, setCount] = useState(1); //mendefinisikan count sbg state yg memiliki nilai 1, u/ mengatur nomor urut
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((item, index) => (
            <tr key={item.id}>
              ...
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="text-sm text-gray-500">{item.harga}</div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="text-sm text-gray-500">{item.expired}</div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
