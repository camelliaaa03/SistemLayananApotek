...
export function Produk () {
  ...
  //   useEffect(() => {
  //   if (user?.roles !== 'admin') {
  //     navigate('/dashboard/kategori'); // Ganti dengan path halaman yang ingin Anda arahkan jika pengguna bukan admin
  //   }
  // }, [user, navigate]);
      ...
      <Card>
        <CardBody>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div class="mb-4">
              <label class="block text-gray-700 text-sm font-bold mb-2" htmlFor="harga">
                Harga
              </label>
              <input
                className="block w-full px-4 py-2 pr-8 rounded-md border border-gray-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
